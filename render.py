...
<div style='background-color: #FFFFFF; padding: 10px; border-radius: 5px; margin-bottom: 10px; display: flex'>
    <div style="width: 20%; display: flex; justify-content: center">
        <img src="https://yt3.googleusercontent.com/ytc/AIdro_kIK55ia3jcirb-DE9ihqU6MlvadGlT1Dq9JBzgMcGc=s900-c-k-c0x00ffffff-no-rj" style="max-height: 35px; max-width: 35px; border-radius: 50%;">
    </div>
    <div style="width: 80%;">
        $MSG
    </div>
...
<div style='background-color: #FAFAFA; padding: 10px; border-radius: 5px; margin-bottom: 10px; display: flex'>
    <div style="width: 78%; text-align: right;">
        $MSG
    </div>
    <div style="width: 20%; margin-left: auto; display: flex; justify-content: center;">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDAW3c4VeojGKTpXQCtoLQG0_VWjzJwVdAEQ&s" style="max-width: 25px; max-height: 25px; float: right; border-radius: 50%;">
    </div>    
</div>
'''
